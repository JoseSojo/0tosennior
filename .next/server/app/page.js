...
/* harmony import */ var next_dist_server_app_render_rsc_preloads__WEBPACK_IMPORTED_MODULE_12___default = /*#__PURE__*/__webpack_require__.n(next_dist_server_app_render_rsc_preloads__WEBPACK_IMPORTED_MODULE_12__);
    ...
    const tree = {
        ...
        {
        children: ['__PAGE__', {}, {
          page: [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 6217)), "/home/demon/Documents/unerg/0tosennior/src/app/page.js"],
          metadata: {
    ...
    manifest: undefined
        ...
        {
          'layout': [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 8227)), "/home/demon/Documents/unerg/0tosennior/src/app/layout.js"],
          metadata: {
    icon: [(async (props) => (await Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 1764))).default(props))],
    apple: [],
    openGraph: [],
    ...
    const pages = ["/home/demon/Documents/unerg/0tosennior/src/app/page.js"];
...
function Home() {
    const mision = {
        title: "Misi\xf3n:",
        description: "Como empresa de educaci\xf3n en l\xednea, nuestra misi\xf3n es proporcinar una educaci\xf3n de calidad y accecible a cualquier persona en cualquier parte del mundo. Nos esfrozamos por ofrecer una plataforma personalizada y f\xe1cil de usar que permita a los estudiantes aprender a su propio ritmo y en su propio horario"
    };
    const vision = {
        title: "Visi\xf3n",
        description: "Nuestra visi\xf3n es proporcionar una plataforma de aprendizaje accecible y efectiva para aquellos que buscan mejorar sus hablidades y conocimientos en campos espec\xedficos. S\xed bien reconocemos que la educaci\xf3n en l\xednea no es adecuada para todos creemos que puede ser una opci\xf3n viable y efectiva para aquellos que buscan una educaci\xf3n de caliad y personalizadda"
    };
    const caso = {
        title: "Caso de Estudio",
        description: "Nuestro equipo not\xf3 que muchos principiantes que deseaban aprender a programar se enfrentaban a varios problemas y desaf\xedos. Uno de los problemas m\xe1s comunes era la falta de acceso a recursos educativos de calidad y asequibles. Muchos cursos en l\xednea son caros y no offrecen la flexibilidad necesaria para que los estudiatnes puedan aprender a su propio ritmo"
    };
    const resena = {
        title: "Rese\xf1a Hist\xf3rica",
        description: "En el a\xf1o 2023, un grupo de emprendedores venezolanoz decidi\xf3 fundar una Empresa de Educaci\xf3n en l\xednea que ofreciera cursos de Programaci\xf3n, Ingl\xe9s, Matem\xe1ticas y Especializaciones Inform\xe1ticas La empresa fundada en San Ju\xe1n de los Morros, estado Gu\xe1rico, por Jos\xe9 Sojo, Grecia Colmenares, Leniangel P\xe9rez, Rossana Ceballos, Rossana Rodr\xedguez, Oscar Tirado, y Victor Acosta, quienes son estudiantes de la Universidad Nacional Experimental de los Llanos Centrales R\xf3mulo Gallegos"
    };
    const valores = [
        "Cooperaci\xf3n",
        "Transparencia",
...
const proxy = (0,next_dist_build_webpack_loaders_next_flight_loader_module_proxy__WEBPACK_IMPORTED_MODULE_0__.createProxy)(String.raw`/home/demon/Documents/unerg/0tosennior/src/app/page.js`)
...
var __webpack_exports__ = __webpack_require__.X(0, [405,475,526], () => (__webpack_exec__(8143)));
